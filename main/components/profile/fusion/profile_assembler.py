...
class ProfileAssembler:
    ...
    def assemble(
        ...
        if apply_insufficient_history(evidence) or cashflow.score is None:
            ...
            if cashflow.score is None:
                policy_flags.append(
                    "INSUFFICIENT_CASHFLOW_HISTORY: Cash-flow model returned no score. "
                    "Readiness index set to None."
                )
        else:

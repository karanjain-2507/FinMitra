    ...
    <header className="sticky top-0 z-50 bg-sage-surface-low border-b border-sage-outline-var">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2.5 group">
          ...
          <span className="text-title-lg font-jakarta text-sage-on-surface tracking-tight">
            FinMitra
          </span>
        </Link>
          ...
          {navLinks.map(({ to, label }) => {
            ...
            return (
              <Link
                ...
                to={to}
                className={`
                  px-4 py-2 rounded-full text-label-lg font-jakarta transition-colors duration-150
                  ${active
